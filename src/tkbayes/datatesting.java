...
public class datatesting {
    ...
    String klasifikasi;
    final double lnlemon=-1.609437912,lnmanis=-1.0986122886,lnnipis=-0.762140052;
...
double posteriorlemon, posteriormanis,posteriornipis;
    public String Pengenalan_Jeruk_Bayes(double a,double b, double c, double d,Datatraining e){
        ...
        for(int i=0;i<4;i++) x+=temp2[i]*temp[i];
        ...
        //System.out.println("covarian : "+e.covarian(e.matriksLemon,4,3));
//        System.out.println("determinan pangkat : "+Math.pow(e.determinant(e.covarian(e.matriksLemon,4,3)), -0.5));
//        System.out.println("det"+(e.determinant(e.covarian(e.matriksLemon,4,3))*-1));
        ...
        for(int i=0;i<4;i++) x2+=temp4[i]*temp3[i];
...
System.out.println("like manis "+f2);
        ...
        for(int i=0;i<4;i++) x3+=temp6[i]*temp5[i];
